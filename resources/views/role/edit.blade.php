    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'direct_sell.to_do_sales_return',  in_array('direct_sell.to_do_sales_return', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.to_do_sales_return' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
