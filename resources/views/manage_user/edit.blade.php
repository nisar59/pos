            ...
            <div class="col-md-2">
                <div class="form-group">
                  {!! Form::label('surname', __( 'business.prefix' ) . ':') !!}
                    {!! Form::select('surname', ['Mr'=>'Mr', 'Mrs'=>'Mrs', 'Miss'=>'Miss'],$user->surname, ['class' => 'form-control']); !!}
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                  {!! Form::label('username', __( 'business.username' ) . ':*') !!}
                    {!! Form::text('username', $user->username, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.username' ) ]); !!}
                </div>
            </div>
