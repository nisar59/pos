...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <button title="@lang('lang_v1.calculator')" id="btnCalculator" type="button" class="rounded-circle btn btn-outline-success pull-right m-5 mt-10 popover-default" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
