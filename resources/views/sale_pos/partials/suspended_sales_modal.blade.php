						...
						<div class="col-xs-6 col-sm-3">
							<div class="small-box bg-yellow">
					            ...
					            <a href="{{action('SellPosController@edit', ['id' => $sale->id]).$subtype}}" class="small-box-footer bg-blue p-10">
					              @lang('Retrieve Sale') <i class="fa fa-arrow-circle-right"  aria-hidden="true" data-container="body" data-toggle="popover" data-placement="auto bottom" data-content="{{$sale->added_by}}" data-html="true" data-trigger="hover" data-original-title="" title=""></i>
					            </a>
