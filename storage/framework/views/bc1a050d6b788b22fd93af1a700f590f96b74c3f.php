...
<?php echo Form::hidden('location_id', $sell->location->id, ['id' => 'location_id', 'data-receipt_printer_type' => $sell->location->receipt_printer_type ]);; ?>
	...
	<?php echo Form::open(['url' => action('SellReturnController@store'), 'method' => 'post', 'id' => '' ]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/sell_return/add.blade.php ENDPATH**/ ?>