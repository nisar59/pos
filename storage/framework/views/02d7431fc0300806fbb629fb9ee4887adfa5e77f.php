    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'supplier.view_own', false, 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'customer.view_own', false, 
          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    <?php echo Form::checkbox('permissions[]', 'purchase_order.view_own', false, 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    <?php echo Form::checkbox('permissions[]', 'purchase_order.view_all', false, 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'direct_sell.view', false, 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'direct_sell.to_do_sales_return', false, 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('permissions[]', 'so.view_own', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('permissions[]', 'so.view_all', false, 
    ...
    <div class="row check_group">
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    <?php echo Form::checkbox('permissions[]', 'access_own_shipping', false, ['class' => 'input-icheck']);; ?>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            <?php echo Form::checkbox('permissions[]', 'all_expense.access', false, 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/role/create.blade.php ENDPATH**/ ?>