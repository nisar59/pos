    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    <?php echo Form::checkbox('permissions[]', 'purchase_order.view_own', in_array('purchase_order.view_own', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    <?php echo Form::checkbox('permissions[]', 'purchase_order.view_all', in_array('purchase_order.view_all', $role_permissions), 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'direct_sell.view', in_array('direct_sell.view', $role_permissions), 
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'lang_v1.view_sale' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('permissions[]', 'direct_sell.to_do_sales_return',  in_array('direct_sell.to_do_sales_return', $role_permissions), 
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'lang_v1.to_do_sales_return' ), false); ?>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'lang_v1.access_sell_return' ), false); ?>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('permissions[]', 'so.view_own', in_array('so.view_own', $role_permissions), 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('permissions[]', 'so.view_all', in_array('so.view_all', $role_permissions), 
        ...
        <div class="row check_group">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        <?php echo Form::checkbox('permissions[]', 'access_own_shipping', in_array('access_own_shipping', $role_permissions), ['class' => 'input-icheck']);; ?>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            <?php echo Form::checkbox('permissions[]', 'all_expense.access', in_array('all_expense.access', $role_permissions), 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/role/edit.blade.php ENDPATH**/ ?>