            ...
            <div class="col-md-2">
                <div class="form-group">
                  <?php echo Form::label('surname', __( 'business.prefix' ) . ':'); ?>
                    ...
                    <?php echo Form::select('surname', ['Mr'=>'Mr', 'Mrs'=>'Mrs', 'Miss'=>'Miss'],$user->surname, ['class' => 'form-control']);; ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <?php echo Form::label('username', __( 'business.username' ) . ':*'); ?>
                    ...
                    <?php echo Form::text('username', $user->username, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.username' ) ]);; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/manage_user/edit.blade.php ENDPATH**/ ?>