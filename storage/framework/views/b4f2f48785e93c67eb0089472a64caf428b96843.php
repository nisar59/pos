...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <a href='http://servxpos.com/business/register' target='_blank'><img src="<?php echo e(URL::asset('theme/ban111.jpg'), false); ?>" alt="Los Angeles"  class="img-fluid">
      </a>
    </div>
    <div class="carousel-item">
     <a href='http://servxpos.com/business/register' target='_blank'> <img src="<?php echo e(URL::asset('theme/ban222.jpg'), false); ?>" alt="Chicago" class="img-fluid">
     </a>
    </div>
    <div class="carousel-item">
    <a href='http://servxpos.com/business/register' target='_blank'>  <img src="<?php echo e(URL::asset('theme/ban333.jpg'), false); ?>" alt="New York"  class="img-fluid">
    </a>
    </div>
  </div>
		...
		<div class="box box-success hvr-grow-shadow">
				...
				?>
					<?php if($package->price != 0): ?>
						<span class="display_currency" data-currency_symbol="true">
							$<?php echo e(round($package->price), false); ?>
			...
			<div class="box-footer bg-gray disabled text-center">
				<?php if($package->enable_custom_link == 1): ?>
					<a href="<?php echo e($package->custom_link, false); ?>" class="btn btn-block btn-success"><?php echo e('Register & Subscribe', false); ?></a>
				<?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\pos\resources\views/bizland/index.blade.php ENDPATH**/ ?>