					...
					<tr>
						...
						<td class="text-right">
							<?php
								...
								$subtotal += $line_total;
							?>
							<?php echo e(number_format($line_total, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>
...
<div class="row invoice-info color-555" style="page-break-inside: avoid !important">
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
            ...
            $formated_number .= number_format((float) $subtotal, config("constants.currency_precision", 2) , session("currency")["decimal_separator"], session("currency")["thousand_separator"]);
...
</table><?php /**PATH C:\xampp\htdocs\pos\resources\views/sale_pos/receipts/elegant.blade.php ENDPATH**/ ?>