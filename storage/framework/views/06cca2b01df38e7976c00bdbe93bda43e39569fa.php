...
<section class="content content-custom no-print">
  <br>
    <?php if(auth()->user()->can('dashboard.data')): ?>
        ...
        <?php if(auth()->user()->can('list_quotations')): ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        sales_order_table = $('#sales_order_table').DataTable({
          ...
          aaSorting: [[1, 'desc']],
          "ajax": {
              "url": '<?php echo e(url("sells?sale_type=sales_order"), false); ?>',
              "data": function ( d ) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/home/index.blade.php ENDPATH**/ ?>