      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            <b><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>:</b> 
              ...
              <?php endif; ?>
              <br/>
            <b><?php echo app('translator')->getFromJson('lang_v1.paid_on'); ?>:</b> <?php echo e(\Carbon::createFromTimestamp(strtotime($single_payment_line->paid_on))->format(session('business.date_format') . ' ' . 'h:i A'), false); ?><br/>
            <br>
...
</div><?php /**PATH C:\xampp\htdocs\pos\resources\views/transaction_payment/single_payment_view.blade.php ENDPATH**/ ?>